# Restaurants & Ramayana Elasticsearch Project

A comprehensive guide to converting CSV datasets to Elasticsearch-compatible JSON and querying them efficiently.

This project includes two datasets:
- **Bengaluru Restaurants**: Kaggle dataset with restaurant information, ratings, locations, and cuisines
- **Ramayana Shlokas**: Ancient Hindu scripture with Sanskrit verses, translations, and explanations
...
- [Restaurants Dataset](#restaurants-dataset)
  - [Schema](#restaurants-schema)
  - [Conversion](#restaurants-conversion)
  - [Sample Queries](#restaurants-sample-queries)
- [Ramayana Dataset](#ramayana-dataset)
  - [Schema](#ramayana-schema)
  - [Conversion](#ramayana-conversion)
  - [Sample Queries](#ramayana-sample-queries)
- [Elasticsearch Bulk Indexing](#elasticsearch-bulk-indexing)
- [Quick Start](#quick-start)

## Features

✅ CSV to JSON/NDJSON conversion with UTF-8 BOM handling
✅ Elasticsearch bulk format generation
✅ Proper data type mappings (text, keyword, geo_point, integer, float)
✅ Support for nested objects and array fields
✅ Comprehensive sample queries for both datasets
✅ Geo-distance searching for restaurants
...
├── README.md                           # This file
├── restaurants/
│   ├── restaurants_converter.py        # CSV to JSON converter
│   ├── schema.json                     # Elasticsearch mapping
│   ├── sample_queries.sh               # Sample cURL queries
│   └── example_data.json              # Sample output
├── ramayana/
│   ├── ramayana_converter.py          # CSV to JSON converter
│   ├── schema.json                     # Elasticsearch mapping
│   ├── sample_queries.sh               # Sample cURL queries
│   └── example_data.json              # Sample output
└── data/
    ├── Bengaluru_Restaurants.csv      # Input data
    └── ramayana.csv                    # Input data
```
